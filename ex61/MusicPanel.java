...
public class MusicPanel extends JPanel {
	...
	public MusicPanel() {
		...
		try {
			...
			JOptionPane.showMessageDialog(new JFrame(), "Error while loading data accessor! " + e.getMessage());		
		}
	...
	class DetailsActionListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent event) {
			...
			MusicDetailsDialog myDetailsDialog = new MusicDetailsDialog(new JFrame(), myMusicRecording);
