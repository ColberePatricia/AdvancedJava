...
public class ApplicationPanel extends JPanel {
	 ...
	 *  in the container.
         ...
         *  @throws IOException if db file cannot be read
	 */
                    ...
                    if (!originalMatrix.Equals(new Matrix(999))){
                        ...
                        if (!originalVector.equals(new double[999])){
                            ...
                            if(originalMatrix.areFormatsCompatible(originalVector)){
                                ...
                                if (!lowerMatrix.Equals(new Matrix(999)) && !upperMatrix.Equals(new Matrix(999)) && originalMatrix.getDeterminant()!=0){
                                    ...
                                    resultOutput.setText("LU Decomposition with scaled partial pivoting\nOriginal matrix\n"+Matrix.MatrixToString(originalMatrix)+"\n\nOriginal vector\n"+Matrix.VectorToString(originalVector)+"\nNo LU decomposition singular matrix");
